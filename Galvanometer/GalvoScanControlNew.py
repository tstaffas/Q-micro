...
class XY:
    ...
    # x_angle = 0.2/0.22         # max X angle.           Valid range = [-22.5, 22.5]
    # y_angle = 0.2/0.22         # max Y angle.           Valid range = [-22.5, 22.5]
...
class T7:
    ...
    # QuTag addresses
    q_start_address = "FIO5"  # marks start of scan                # TODO: FILL IN
    q_stop_address = "FIO5"  # marks end of scan                  # TODO: FILL IN
    q_step_address = "FIO7"  # marks each change in x value       # TODO: FILL IN
    ...
    def get_scan_parameters(self):
        ...
        print(
            f"NOTE: Dimension of y values (one period) = y_dim = {self.y_dim} ≤ {int(1000 / self.y_frequency)} = 1000/y_frequency")

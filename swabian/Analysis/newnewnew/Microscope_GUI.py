...
class GUI:
    ...
    def start_scan_widget(self, tab):
        ...
        btn_stop = tk.Button(frm_send, text="Stop", command=press_stop, activeforeground='blue',
                             highlightbackground=self.button_color)
    ...
    def ETA_analysis(self):
        ...
        timetag_file = None  # 'nr_6_dup_marker_sineFreq(1)_numFrames(2)_sineAmp(0.3)_stepAmp(0.3)_stepDim(100)_date(231103)_time(14h48m42s).timeres'  # Note: let this be None if you want to use "clue" and "folder" to automatically find your file based on frequency

        # Scan parameters:
        nr_frames = 2  # OBS: SET VALUE TO USE DATAFILE

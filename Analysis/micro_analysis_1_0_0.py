...
import q_micro_lib_1_0_0 as Q #Contains functions for image analysis and image construction for the quantum microscope
...
recipe = "/Users/mikaelschelin/Documents/QNP/Q-micro/ETA_recipe/Countrate-qutag_micro.eta" #ETA_recipe file
# make sure correct channel in recipe! 

#.timeres file to be analysed
file = '/Users/mikaelschelin/Documents/QNP/Q-micro/Data/number8_LV_0mA_50000counts_amp009v5_[100,100]_[x,y]_[-0.02, 0]_xlim_0.09_amp_0.5_yfreq__bias_-12.65uA_30kHz_Cts_221116.timeres'
#file = '/Users/mikaelschelin/Documents/QNP/Q-micro/Data/number8_LV_0mA_50000counts_v5_[100,100]_[x,y]_[-0.02, 0]_xlim_0.05_amp_0.5_yfreq__bias_-12.65uA_30kHz_Cts_221116.timeres'
#file = '/Users/mikaelschelin/Documents/QNP/Q-micro/Data/1550_fig6_v2_[100,100]_[x,y]_[-0.03, 0.02]_xlim_0.15_amp_0.5_yfreq__bias_-12.65uA_30kHz_Cts_221206.timeres'
...
#create modified realtime
realtime = realtime[0:index_0]

print("Lenght of countrate " + str(len(countrate)))
print("Lenght of time_axis " + str(len(time_axis)))
...
#imatrix = Q.createAdjustedMatrix(dimX, dimY, Sbins, pixelAY, velocitybinlist, countrate) 
...
threshold = 60000 #set threshold of pixel values

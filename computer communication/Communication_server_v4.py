...
def scan_function():
    ...
    for a in amp:
        ...
        while a < endpos:
            ...
            LJ.ping_FIO(X_port, time_delay=0.0, voltage = 1)     # 2nd marker in port and address
...
def main():
    ...
    file = "analysis"
    scantime = 50              #duration of the scan on the microscope

    socket_connection(file,scantime)
    print('a')
    time.sleep(1)              #waits for 5 secs
    print('b')
